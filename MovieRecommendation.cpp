...
public:
    ...
    void displayTopRated() {
        ...
        for (int i = 0; i < limit; i++) {
            cout << "\nRank " << i + 1 << ":\n";
            cout << "Title: " << movieArray[i]->movieTitle << "\n";
            cout << "Genre: " << movieArray[i]->movieGenre << "\n";
            cout << "Rating: " << movieArray[i]->movieRating << "/10\n";
            cout << "Year: " << movieArray[i]->movieYear << "\n";
        }
    }
};
...
public:
    ...
    void startSystem() {
        ...
        while (true) {
            ...
            else if (choice == 10) movieDatabase.displayTopRated();
